...
//Name: nps-m_look_left.ma
//Last modified: Tue, Jul 16, 2002 11:05:14 AM
requires maya "4.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "nps_look_left";
	setAttr ".ihi" 0;
	setAttr ".du" 30;
	setAttr ".ci" no;
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "nps_look_left.st" "clipLibrary2.st[0]";
connectAttr "nps_look_left.du" "clipLibrary2.du[0]";
