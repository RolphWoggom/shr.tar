...
//Name: nps_look_right.ma
//Last modified: Tue, Jun 17, 2003 03:39:50 PM
requires maya "4.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "nps_look_rightSource";
	setAttr ".ihi" 0;
	setAttr ".du" 30;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL85";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 1.0073933882855994 30 1.0073933882855994;
...
createNode animCurveTL -n "animCurveTL87";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.8220940684186907 30 0.8220940684186907;
...
createNode animCurveTL -n "animCurveTL91";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.0838930914137086 3 1.0838930914137086 
		9 1.0838930914137086 13 1.0838930914137086 23 1.0838930914137086 30 1.0838930914137086;
...
createNode animCurveTL -n "animCurveTL94";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.5633250941349235 3 1.5633250941349235 
		9 1.5633250941349235 13 1.5633250941349235 23 1.5633250941349235 30 1.5633250941349235;
	setAttr -s 6 ".kit[3:5]"  3 3 9;
	setAttr -s 6 ".kot[3:5]"  3 3 9;
...
createNode animCurveTL -n "animCurveTL97";
	...
	setAttr -s 6 ".ktv[0:5]"  0 0.097466557943624466 3 0.097466557943624466 
		9 0.097466557943624466 13 0.097466557943624466 23 0.097466557943624466 30 
...
createNode animCurveTL -n "animCurveTL100";
	...
	setAttr -s 6 ".ktv[0:5]"  0 0.011621961304049206 3 0.011621961304049206 
		9 0.011621961304049206 13 0.011621961304049206 23 0.011621961304049206 30 
...
createNode animCurveTL -n "animCurveTL103";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.4244680778754275 3 1.4244680778754275 
		9 1.4244680778754275 13 1.4244680778754275 23 1.4244680778754275 30 1.4244680778754275;
	setAttr -s 6 ".kit[3:5]"  3 3 9;
	setAttr -s 6 ".kot[3:5]"  3 3 9;
...
createNode animCurveTL -n "animCurveTL106";
	...
	setAttr -s 31 ".ktv[0:30]"  0 -0.38197593353053522 1 -0.39866481884569055 
		...
		10 -0.38136845248562906 11 -0.32728658034924818 12 -0.2890330548649786 13 
		-0.27770807250874724 14 -0.28089348520084201 15 -0.28369085078341838 16 -0.28591472365468973 
		17 -0.28741342434887002 18 -0.28807133626694592 19 -0.28781162192753867 20 
		-0.28659944468281623 21 -0.28444575806923239 22 -0.28141169704043023 23 -0.27761357281728549 
		24 -0.2762917508895828 25 -0.28082719264231998 26 -0.29148942551182616 27 
		-0.30818769291276055 28 -0.33014849350135989 29 -0.3556555525639678 30 -0.38197593353053522;
...
createNode animCurveTL -n "animCurveTL108";
	...
	setAttr -s 31 ".ktv[0:30]"  0 0.4628073796737307 1 0.42684918763929364 
		2 0.39029543484848889 3 0.36763216281581385 4 0.35871591881197362 5 0.35338383829001024 
...
createNode animCurveTA -n "animCurveTA272";
	...
	setAttr -s 31 ".ktv[0:30]"  0 4.6931680813932024 1 -8.2763368915596054 
		...
		10 -31.259776566164426 11 -31.109609856234311 12 -10.737576702785544 13 0.76507114088143191 
		...
		22 2.8174392396794938 23 2.2026212744913058 24 -0.44714388236007641 25 -6.5615056075728138 
...
createNode animCurveTA -n "animCurveTA273";
	...
	setAttr -s 31 ".ktv[0:30]"  0 82.169846625535428 1 80.34153886488096 
		...
		18 68.25217766908159 19 68.328942699046422 20 68.656910545502328 21 69.223163016186035 
...
createNode animCurveTL -n "animCurveTL109";
	...
	setAttr -s 31 ".ktv[0:30]"  0 0.053946154130855462 1 0.030252405433552669 
		...
		16 0.54927813749847343 17 0.5534604714213559 18 0.55486896741961067 19 0.55365187564031049 
		20 0.54993765934717243 21 0.54383495265156812 22 0.53543316148547415 23 0.52480360378473667 
		24 0.49999363127158075 25 0.45172393162743246 26 0.38428797830384864 27 0.30324658499286955 
		28 0.215754502412629 29 0.12995894527437854 30 0.053946154130855462;
...
createNode animCurveTA -n "animCurveTA277";
	...
	setAttr -s 31 ".ktv[0:30]"  0 -30.60757801954858 1 -37.409003412201365 
		...
		10 -47.117360897718413 11 -39.986629676141767 12 -30.170125715434249 13 -24.220257072060704 
		14 -23.315293751637657 15 -22.604730265619317 16 -22.097103862015338 17 -21.790440881761249 
		18 -21.677466883163323 19 -21.748806000729644 20 -21.994824560961067 21 -22.406708062071797 
...
createNode animCurveTL -n "animCurveTL114";
	...
	setAttr -s 6 ".kiy[3:5]"  -0.99986141920089722 0.99987208843231201 
		0.99997878074645996;
...
createNode animCurveTA -n "animCurveTA278";
	...
	setAttr -s 6 ".kix[3:5]"  0.81347930431365967 0.97165679931640625 
		0.3192618191242218;
	setAttr -s 6 ".kiy[3:5]"  0.58159393072128296 -0.23639601469039917 
		-0.94766652584075928;
...
createNode animCurveTA -n "animCurveTA280";
	...
	setAttr -s 6 ".kix[3:5]"  0.7117842435836792 0.77371042966842651 
		0.30014106631278992;
	setAttr -s 6 ".kiy[3:5]"  0.70239818096160889 -0.63353937864303589 
		-0.95389485359191895;
...
createNode animCurveTL -n "animCurveTL115";
	...
	setAttr -s 6 ".kit[3:5]"  1 1 9;
	setAttr -s 6 ".kot[3:5]"  1 1 9;
	setAttr -s 6 ".kix[3:5]"  0.032478943467140198 0.044165089726448059 
...
createNode animCurveTL -n "animCurveTL116";
	...
	setAttr -s 6 ".kiy[3:5]"  -0.98774802684783936 0.97953099012374878 
		0.99929773807525635;
...
createNode animCurveTL -n "animCurveTL118";
	...
	setAttr -s 6 ".ktv[0:5]"  0 0.77290696453185026 3 0.77290696453185026 
		9 0.77290696453185026 13 0.77290696453185026 23 0.77290696453185026 30 0.77290696453185026;
	setAttr -s 6 ".kit[3:5]"  3 3 9;
	setAttr -s 6 ".kot[3:5]"  3 3 9;
...
createNode animCurveTA -n "animCurveTA321";
	...
	setAttr -s 6 ".ktv[0:5]"  0 7.5470594542643701 3 7.7360936746637758 
		9 7.7360936746637758 13 6.401622397513365 23 6.39543951910409 30 7.5470594542643701;
	setAttr -s 6 ".kit[3:5]"  1 1 9;
	setAttr -s 6 ".kot[3:5]"  1 1 9;
...
createNode animCurveTA -n "animCurveTA322";
	...
	setAttr -s 6 ".kix[3:5]"  0.99241846799850464 0.98743873834609985 
		0.18371056020259857;
	setAttr -s 6 ".kiy[3:5]"  -0.12290474772453308 0.15800230205059052 
		0.98298037052154541;
...
createNode animCurveTA -n "animCurveTA328";
	...
	setAttr -s 6 ".kix[3:5]"  0.99606567621231079 0.99847990274429321 
		0.83456385135650635;
	setAttr -s 6 ".kiy[3:5]"  -0.088618181645870209 0.055116459727287292 
		0.55091118812561035;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "nps_look_rightSource.st" "clipLibrary1.st[0]";
connectAttr "nps_look_rightSource.du" "clipLibrary1.du[0]";
