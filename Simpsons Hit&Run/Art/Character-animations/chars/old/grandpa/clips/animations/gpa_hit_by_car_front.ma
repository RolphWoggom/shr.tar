...
//Name: gpa_hit_by_car_front.ma
//Last modified: Tue, Aug 13, 2002 10:26:07 AM
requires maya "4.0";
requires "p3dSimpleShader" "18.0";
currentUnit -l meter -a degree -t film;
createNode animClip -n "gpa_hit_by_car_frontSource";
	setAttr ".ihi" 0;
	setAttr ".du" 34;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "gpa_hit_by_car_frontSource.st" "clipLibrary2.st[0]";
connectAttr "gpa_hit_by_car_frontSource.du" "clipLibrary2.du[0]";
...
// End of gpa_hit_by_car_front.ma
