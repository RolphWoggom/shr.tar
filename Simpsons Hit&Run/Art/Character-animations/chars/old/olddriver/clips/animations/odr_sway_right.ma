...
//Name: odr_sway_right.ma
//Last modified: Tue, Aug 13, 2002 05:12:54 PM
requires maya "4.0";
requires "p3dmayaexp" "18.2";
requires "p3dSimpleShader" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "odr_sway_rightSource";
	setAttr ".ihi" 0;
	setAttr ".du" 30;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "odr_sway_rightSource.st" "clipLibrary2.st[0]";
connectAttr "odr_sway_rightSource.du" "clipLibrary2.du[0]";
