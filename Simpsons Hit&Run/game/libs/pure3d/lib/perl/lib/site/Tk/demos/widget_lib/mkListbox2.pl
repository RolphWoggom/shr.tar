...
sub mkListbox2 {
    ...
    my $w_frame_list = $w_frame->Listbox(-yscrollcommand => ['set', $w_frame_scroll], -width => 20, -height => 20,
				    -setgrid => 1);
    ...
    $w_frame_list->insert(0, qw(snow1 snow2 snow3 snow4 seashell1 seashell2 seashell3 seashell4 AntiqueWhite1 AntiqueWhite2
