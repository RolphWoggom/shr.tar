...
// ************************************************************************
// NOTE: All new entries in this file must be made at the end so that the
// binary values assigned to existing entries in the enum are not affected.
// ************************************************************************
...
///
		kSubdCleanTopology,
///
		// This must go at the end of the list.  Add entries for new 
		// nodes immediately before this comment.
///
		kLast,
